    ...
    const fetchAllData = async () => {
      try {
        ...
        const sortedCycles = [...(cyclesRes.cycles || [])].sort((a, b) => {
          const aDate = a.startDate ? new Date(a.startDate.value).getTime() : 0;
          const bDate = b.startDate ? new Date(b.startDate.value).getTime() : 0;
          return bDate - aDate;
        });
    ...
    return (
      <Page pageContent={false}>
        <div className="page-content">
          <Navbar title="Clinician Summary" backLink="Back" />
