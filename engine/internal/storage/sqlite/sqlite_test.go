...
func TestBleeding_CreateListDeleteByUser(t *testing.T) {
	s := newStore(t)
	s.BleedingObservations().Create(ctx, bleeding("b1", "u1", "2026-01-01T00:00:00Z")) //nolint:errcheck
	s.BleedingObservations().Create(ctx, bleeding("b2", "u1", "2026-01-08T00:00:00Z")) //nolint:errcheck
	s.BleedingObservations().Create(ctx, bleeding("b3", "u2", "2026-01-01T00:00:00Z")) //nolint:errcheck
	...
	if err := s.BleedingObservations().DeleteByUser(ctx, "u1"); err != nil {
		t.Fatal(err)
	}
...
func TestSymptom_CreateListDeleteByUser(t *testing.T) {
	s := newStore(t)
	s.SymptomObservations().Create(ctx, symptom("s1", "u1", "2026-01-01T00:00:00Z")) //nolint:errcheck
	s.SymptomObservations().Create(ctx, symptom("s2", "u1", "2026-01-08T00:00:00Z")) //nolint:errcheck
	s.SymptomObservations().Create(ctx, symptom("s3", "u2", "2026-01-01T00:00:00Z")) //nolint:errcheck
	...
	if err := s.SymptomObservations().DeleteByUser(ctx, "u1"); err != nil {
		t.Fatal(err)
	}
...
func TestMood_CreateListDeleteByUser(t *testing.T) {
	s := newStore(t)
	s.MoodObservations().Create(ctx, mood("m1", "u1", "2026-01-01T00:00:00Z")) //nolint:errcheck
	s.MoodObservations().Create(ctx, mood("m2", "u1", "2026-01-08T00:00:00Z")) //nolint:errcheck
	s.MoodObservations().Create(ctx, mood("m3", "u2", "2026-01-01T00:00:00Z")) //nolint:errcheck
	...
	if err := s.MoodObservations().DeleteByUser(ctx, "u1"); err != nil {
		t.Fatal(err)
	}
...
func TestMedication_CreateListDeleteByUser(t *testing.T) {
	s := newStore(t)
	s.Medications().Create(ctx, med("med1", "u1")) //nolint:errcheck
	s.Medications().Create(ctx, med("med2", "u1")) //nolint:errcheck
	s.Medications().Create(ctx, med("med3", "u2")) //nolint:errcheck
	...
	if err := s.Medications().DeleteByUser(ctx, "u1"); err != nil {
		t.Fatal(err)
	}
...
func TestMedicationEvent_CreateListDeleteByUser(t *testing.T) {
	s := newStore(t)
	s.Medications().Create(ctx, med("med1", "u1"))                                          //nolint:errcheck
	s.MedicationEvents().Create(ctx, medEvent("ev1", "u1", "med1", "2026-01-01T08:00:00Z")) //nolint:errcheck
	s.MedicationEvents().Create(ctx, medEvent("ev2", "u1", "med1", "2026-01-02T08:00:00Z")) //nolint:errcheck
	s.Medications().Create(ctx, med("med2", "u2"))                                          //nolint:errcheck
	s.MedicationEvents().Create(ctx, medEvent("ev3", "u2", "med2", "2026-01-01T08:00:00Z")) //nolint:errcheck
	...
	if err := s.MedicationEvents().DeleteByUser(ctx, "u1"); err != nil {
		t.Fatal(err)
	}
...
func TestCycle_CreateListDeleteByUser(t *testing.T) {
	s := newStore(t)
	s.Cycles().Create(ctx, cycleRecord("c1", "u1", "2026-01-01", "2026-01-28")) //nolint:errcheck
	s.Cycles().Create(ctx, cycleRecord("c2", "u1", "2026-01-29", "2026-02-25")) //nolint:errcheck
	s.Cycles().Create(ctx, cycleRecord("c3", "u2", "2026-01-01", "2026-01-28")) //nolint:errcheck
	...
	if err := s.Cycles().DeleteByUser(ctx, "u1"); err != nil {
		t.Fatal(err)
	}
...
func TestPhaseEstimate_DeleteByUser(t *testing.T) {
	s := newStore(t)
	s.PhaseEstimates().Create(ctx, phaseEstimate("pe1", "u1", "2026-01-05", "c1")) //nolint:errcheck
	s.PhaseEstimates().Create(ctx, phaseEstimate("pe2", "u1", "2026-01-06", "c1")) //nolint:errcheck
	s.PhaseEstimates().Create(ctx, phaseEstimate("pe3", "u2", "2026-01-05", "c2")) //nolint:errcheck
	...
	if err := s.PhaseEstimates().DeleteByUser(ctx, "u1"); err != nil {
		t.Fatal(err)
	}
